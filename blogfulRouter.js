...
BlogPosts.create("Ice Climbing", "ice climning is pretty fun, you really should give it a try", "Lara Croft");
BlogPosts.create("How to make orchata", ["step1: boil rice","step2: strain milk", "step3: add cinnamon, ice and dates for sweetness"], "Nathaniel Acosta");
...
router.put('/:id', jsonParser, (req,res) => {
    if(req.params.id !== req.body.id){
        res.status(400).send("ERROR: either your id doesn't exist or ir doesn't match with the one in the url");
    }
